"""BambooHR ATS application engine built on the shared engine foundation."""
...
def _parser() -> argparse.ArgumentParser:
    return build_engine_parser("BambooHR application engine")
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    try:
        ...
        logger.exception("BambooHR engine failed")
        result = {
            "success": False,
