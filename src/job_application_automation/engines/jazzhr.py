"""JazzHR ATS application engine built on the shared engine foundation."""
...
def _parser() -> argparse.ArgumentParser:
    return build_engine_parser("JazzHR application engine")
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    try:
        ...
        logger.exception("JazzHR engine failed")
        result = {
            "success": False,
