...
| **2** | **Direct Native GraphQL API Submission (Ashby)** | [ashby.py](file:///c:/Users/Nagarro/Downloads/Job%20App%20Automation/src/job_application_automation/engines/ashby.py) | 80 | 3.0 | 100% | 1.0 | **240.0** |
...
| **15** | **Stealth CDP Engine with Fingerprint Randomization** | [engine_shared.py](file:///c:/Users/Nagarro/Downloads/Job%20App%20Automation/src/job_application_automation/core/engine_shared.py) | 80 | 2.5 | 80% | 2.0 | **80.0** |
...
| **22** | **Biometric Mouse Trajectory & Humanized Typing** | [ashby.py](file:///c:/Users/Nagarro/Downloads/Job%20App%20Automation/src/job_application_automation/engines/ashby.py) | 70 | 1.5 | 80% | 1.5 | **56.0** |
...
### 2. Direct Native GraphQL API Submission for Ashby (RICE: 240.0)
- **Target File**: [ashby.py](file:///c:/Users/Nagarro/Downloads/Job%20App%20Automation/src/job_application_automation/engines/ashby.py#L1-L25)
- **Reach (80)**: Affects all Ashby job applications.
- **Impact (3.0)**: Reduces execution time from ~35 seconds per application down to <400ms. Eliminates Chromium memory leaks, Playwright timeouts, and browser rendering failures.
- **Confidence (100%)**: Ashby's public application form relies on an unauthenticated public GraphQL API (`ApiJobAppFormSubmit`).
- **Effort (1.0 day)**: Reverse-engineer payload schema and construct lightweight HTTP POST request layer.
...
gantt
    ...
    Ashby Direct GraphQL POST    :p3, after p2, 1d
    Asyncio HTTP/2 Search Engine :p4, after p3, 2d
    ...
    Stealth CDP Fingerprinting   :p9, after p8, 2d
```
