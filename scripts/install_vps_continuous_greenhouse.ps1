# Installs or repairs the persistent one-application-at-a-time Greenhouse worker.
param(
    [string]$RemoteRepoPath = "/root/Job-App-Automation",
    [string]$ConfigPath = "config/vps_config.json",
    [string]$ServiceTemplatePath = "scripts/job-app-greenhouse.service.template"
)
...
$ServiceName = "job-app-greenhouse.service"
...
test -f "`$repo/src/job_application_automation/core/continuous_greenhouse.py"
...
Write-Host (
    "Installed and started $ServiceName. The replaced daily cron cannot race " +
    "the one-job continuous worker."
)
